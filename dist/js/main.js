    ...
    $(document).ready(function () {
        ...
        $('input[type=checkbox]').change(function () {
            ...
            $frames.find('iframe').each(function (i, el) {
                $(el).attr('width', parseInt($(el).attr('width'), 0) + scrollBarWidth);
            });
        });
        ...
        $('iframe').load(function () {
            ...
            if (allLoaded()) {
                if (error) {
                    console.log('Browsers prevent navigation from inside iframes across domains.\nPlease use the textbox at the top for external sites.');
                    loadPage('', defaultURL);
                } else {
                    loadPage($this, url);
                }
